module PFM
  ...
  class Storage
    ...
    # @param game_state [PFM::Pokemon_Party] variable responsive of containing the whole game state for easier access
  ...
  safe_code('Storage system definition in Save') do
    class Pokemon_Party
      # The PC storage of the player
      # @return [PFM::Storage]
      attr_accessor :storage
      on_player_initialize(:storage) { @storage = PFM::Storage.new(self) }
