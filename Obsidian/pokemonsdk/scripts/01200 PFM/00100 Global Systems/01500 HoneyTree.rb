module PFM
  module HoneyTree
    ...
    def get(id)
      ...
      return $pokemon_party.honey_trees[id] ||= { column: 0, sakes: 0, mon_index: 0 }
    end
    ...
    # @return [Integer]
    def last_tree_id
      return $pokemon_party.user_data[:last_honey_tree] || -1
    end

    # Set the ID of the last tree
    # @param id [Integer] ID of the tree
    def last_tree_id=(id)
      $pokemon_party.user_data[:last_honey_tree] = id
    end
    ...
    def last_mon_index=(index)
      $pokemon_party.user_data[:last_honey_mon_index] = index
    end
