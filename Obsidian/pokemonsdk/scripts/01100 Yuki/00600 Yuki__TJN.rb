module Yuki
  ...
  #   - $pokemon_party.tint_time_set : Name of the time set (symbol) to use in order to get the tone
  #
  # It's outputs are :
  ...
  module TJN
    ...
    class << self
      ...
      def current_time_set
        TIME_SETS[$pokemon_party.tint_time_set] || TIME
      end

      # Get the tone set
      # @return [Array<Tone>] 5 values : night, evening, morning / night, day, dawn
      def current_tone_set
        TONE_SETS[$pokemon_party.tint_time_set] || TONE
      end
