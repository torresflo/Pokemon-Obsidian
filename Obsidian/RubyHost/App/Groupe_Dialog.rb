...
class Groupe_Dialog < DialogHost
  ...
  TEXT_SPLIT = "("
  TYPE_FORMAT = '%d - %s'
  Zones = ["Herbe (0)","Hautes herbes (1)","Très hautes herbes (2)","Grottes (3)","Montagnes (4)","Sable (5)","Etang (6)","Océan (7)","Fonds marins (8)","Neige (9)","Glace (10)"]
  Tags = ["0","1","2","3","4","5","6","7","Canne","SuperCanne","MegaCanne","Eclate Roc","Coup de boule"]
